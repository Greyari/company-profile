...
const solutions = [
  {
    ...
    description:
      "All in one system fingerprint / rfid fingerprint / battery fingerprint integration system for security solutions management.",
    image: "/images/solution1.jpg",
  },
  {
    title: "CCTV & Security System",
    description:
      "Comprehensive surveillance solutions for your business security needs.",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {solutions.map((solution, index) => (
            <div
              key={index}
              className="bg-white rounded-lg overflow-hidden shadow-lg group hover:shadow-xl transition"
            >
